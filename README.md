...
| 9–11 | Reinsurance, settlement, agent API | Specified, not built — `docs/roadmap.md` |
...
suite. See `docs/reports/phase-2.md` through `docs/reports/phase-8.md` for
...
low-confidence placeholder, not an actuarial model.
